...
Public Class Launcher
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Shell("Explorer.exe fivem://connect/onkelinfo.de:30120")
    End Sub

    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Shell("Explorer.exe https://discord.com/invite/5z2YdnsGgY")
    End Sub

    Private Sub gotoTS_Click(sender As Object, e As EventArgs) Handles gotoTS.Click
        Shell("Explorer.exe ts3server://ts.onkelinfo.de")
    End Sub

    Private Sub GotoWeb_Click(sender As Object, e As EventArgs) Handles GotoWeb.Click
        Dim unused = Shell("Explorer.exe https://onkelinfo.de/")
    End Sub
